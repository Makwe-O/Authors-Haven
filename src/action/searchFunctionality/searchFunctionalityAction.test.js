...
describe('Forgot Password Actions', () => {
  ...
  test('Dispatches the correct action and payload when a success response is return', () => {
    ...
    mock
      .onGet('https://adv-backend.herokuapp.com/api/v1/users/jesseinit/following', {})
  ...
  test('Dispatches the correct action and payload when a success response is return', () => {
    ...
    const mock = new MockAdapter(Axios);
    mock
      .onPost('https://adv-backend.herokuapp.com/api/v1/users/jesseinit/follow', {})
  ...
  test('Dispatches the correct action and payload when a success response is return', () => {
    const mock = new MockAdapter(Axios);
    mock
      .onGet('https://adv-backend.herokuapp.com/api/v1/user/bookmarks', {})
  ...
  test('Dispatches the correct action and payload when a success response is return', () => {
    const mock = new MockAdapter(Axios);
    mock.onPost('https://adv-backend.herokuapp.com/api/v1/articles/bookmark/bookmark', {}).reply(200);
  ...
  test('Dispatches the correct action and payload when a success response is return', () => {
    const mock = new MockAdapter(Axios);
    mock.onGet('https://adv-backend.herokuapp.com/api/v1/search?author=s', {}).reply(200, {
