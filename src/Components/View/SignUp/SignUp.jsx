        ...
        <div className="site-modal">
          ...
          <div className="site-modal__details">
            ...
            <Grid columns="2">
              <Grid.Row>
                <Grid.Column>
                  <Button fluid as="a" href="https://adv-backend.herokuapp.com/api/v1/auth/google" color="google plus">
                    <Icon name="google" />
                    Google
                  </Button>
                </Grid.Column>
                <Grid.Column>
                  <Button fluid as="a" href="https://adv-backend.herokuapp.com/api/v1/auth/facebook" color="facebook">
                    <Icon name="facebook" />
                    Facebook
                  </Button>
                </Grid.Column>
              ...
              <Grid.Row>
                <Grid.Column>
                  <Button fluid as="a" href="https://adv-backend.herokuapp.com/api/v1/auth/twitter" color="twitter">
                    <Icon name="twitter" />
                    Twitter
                  </Button>
                </Grid.Column>
                <Grid.Column>
                  <Button fluid as="a" href="https://adv-backend.herokuapp.com/api/v1/auth/linkedin" color="linkedin">
                    <Icon name="linkedin" />
                    LinkedIn
                  </Button>
                </Grid.Column>
